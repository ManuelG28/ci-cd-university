...
public class ProtobootappApplication {
    ...
    @GetMapping("/")
    public String index() {
        return String.format("Bienvenido! Esta aplicación ayuda a elevar números a sus potencias y otras características. El ci/cd fue realizado para el curso de entrega continua de la Universidad EAFIT");
    }    
...
//Se ejecuta con http://localhost:8080/hola o http://localhost:8080/hola?nombre=John
    ...
    public String hola(@RequestParam(value = "nombre", defaultValue = "Mundo") String nombre) {
        return String.format("Hola %s! sea usted bienvenido", nombre);
    }
